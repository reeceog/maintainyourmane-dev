<div class="booked-settings-wrap wrap">
	...
	<div class="booked-settings-title"><?php _e('Booking Settings','booked'); ?></div>
						...
						case 'general': ?>
							...
							<form action="options.php" class="booked-settings-form" method="post">
								...
								<div id="booked-general" class="tab-content">
									...
									if (!is_plugin_active('booked-woocommerce-payments/booked-woocommerce-payments.php')): ?>
										...
										<div class="section-row">
											<div class="section-head">
												...
												<p><?php _e('You have the option to choose between "Registered" and "Guest" booking. Registered booking will require all Bookings to be booked by a registered user (default). Guest booking will allow anyone with a name and email address to book a Booking.','booked'); ?></p>
									...
									<div class="section-row">
										<div class="section-head">
											<?php $section_title = __('Booking Booking Redirect', 'booked'); ?>
											<h3><?php echo esc_attr($section_title); ?></h2>
											<p><?php _e('If you would like to direct your users to a custom page after a successful Booking booking (instead of going to the selected Profile Page above), you can choose a page here.','booked'); ?></p>
									...
									<div class="section-row">
										<div class="section-head">
											...
											<h3><?php echo esc_attr($section_title); ?></h2>
											<p><?php _e('Choose the intervals you need for Bookings. This will only affect the way default Bookings are entered.','booked'); ?></p>
									...
									<div class="section-row">
										<div class="section-head">
											<?php $section_title = __('Booking Buffer', 'booked'); ?>
											<h3><?php echo esc_attr($section_title); ?></h2>
											<p><?php _e('To prevent Bookings from getting booked too close to the current date and/or time, you can set an Booking buffer. Available Bookings Bookings will be pushed up to a new date and time depending on which buffer amount you choose below.','booked'); ?></p>
									...
									<div class="section-row">
										<div class="section-head">
											...
											<h3><?php echo esc_attr($section_title); ?></h2>
											<p><?php _e('To prevent Bookings from getting cancelled too close to the Booking time, you can set a cancellation buffer.','booked'); ?></p>
									...
									<div class="section-row">
										<div class="section-head">
											<?php $section_title = __('Booking Limit', 'booked'); ?>
											<h3><?php echo esc_attr($section_title); ?></h2>
											<p><?php _e('To prevent users from booking too many Bookings, you can set a Booking limit.','booked'); ?></p>
											...
											$interval_options = array(
												...
												'1' 				=> __('1 Booking','booked'),
												'2' 				=> __('2 Bookings','booked'),
												'3' 				=> __('3 Bookings','booked'),
												'4' 				=> __('4 Bookings','booked'),
												'5' 				=> __('5 Bookings','booked'),
												'6' 				=> __('6 Bookings','booked'),
												'7' 				=> __('7 Bookings','booked'),
												'8' 				=> __('8 Bookings','booked'),
												'9' 				=> __('9 Bookings','booked'),
												'10' 				=> __('10 Bookings','booked'),
												'15' 				=> __('15 Bookings','booked'),
												'20' 				=> __('20 Bookings','booked'),
												'25' 				=> __('25 Bookings','booked'),
												'50' 				=> __('50 Bookings','booked'),
											); ?>
									...
									<div class="section-row">
										<div class="section-head">
											<?php $section_title = __('New Booking Default', 'booked'); ?>
											<h3><?php echo esc_attr($section_title); ?></h2>
											<p><?php _e('Would you like your Booking requests to go into a pending list or should they be approved immediately?','booked'); ?></p>
									...
									<div class="section-row cf">
										<div class="section-head">
											...
											<label class="checkbox-radio-label" for="<?php echo $option_name; ?>"><?php _e('Hide unavailable Bookings (on the front-end)','booked'); ?></label><br><br>
											...
											<label class="checkbox-radio-label" for="<?php echo $option_name; ?>"><?php _e('Do not allow users to cancel their own Bookings.','booked'); ?></label><br><br>
											...
											<label class="checkbox-radio-label" for="<?php echo $option_name; ?>"><?php _e('Hide "+ Google Calender" button in Booking list','booked'); ?></label><br><br>
...
Thanks for registering at '.get_bloginfo('name').'. You can now login to manage your account and Bookings using the following credentials:
...
This is just an email to confirm your enquiry for a Booking. For reference, here\'s the Booking information:
...
Your friends at '.get_bloginfo('name');
											...
											$section_title = __('Email Content - Booking Confirmation', 'booked'); ?>

											<h3><?php echo esc_attr($section_title); ?></h3>
											<p><?php _e('The email content that is sent to the user upon Booking creation. Some tokens you can use:','booked'); ?></p>
											<ul class="cp-list">
												<li><strong>%name%</strong> &mdash; <?php _e("To display the person's name.","booked"); ?></li>
												<li><strong>%email%</strong> &mdash; <?php _e("To display the person's email address.","booked"); ?></li>
												<li><strong>%calendar%</strong> &mdash; <?php _e("To display the calendar name (if one is used) for this Booking.","booked"); ?></li>
												<li><strong>%date%</strong> &mdash; <?php _e("To display the Booking date.","booked"); ?></li>
												<li><strong>%time%</strong> &mdash; <?php _e("To display the Booking time.","booked"); ?></li>
												<li><strong>%customfields%</strong> &mdash; <?php _e("To display all custom field values associated with this Booking.","booked"); ?></li>
											</ul><br>

											<?php

											$subject_var = 'booked_appt_confirmation_email_subject';
											$subject_default = 'Your Booking confirmation from '.get_bloginfo('name').'.';
											$current_subject_value = get_option($subject_var,$subject_default); ?>
...
The Booking you requested at '.get_bloginfo('name').' has been approved! Here\'s your Booking information:
...
Your friends at '.get_bloginfo('name');
											...
											$email_content_approval = get_option($option_name,$default_content);
											$section_title = __('Email Content - Booking Approval', 'booked'); ?>

											<h3><?php echo esc_attr($section_title); ?></h3>
											<p><?php _e('The email content that is sent to the user upon Booking approval. Some tokens you can use:','booked'); ?></p>
											<ul class="cp-list">
												<li><strong>%name%</strong> &mdash; <?php _e("To display the person's name.","booked"); ?></li>
												<li><strong>%email%</strong> &mdash; <?php _e("To display the person's email address.","booked"); ?></li>
												<li><strong>%calendar%</strong> &mdash; <?php _e("To display the calendar name (if one is used) for this Booking.","booked"); ?></li>
											...
											$subject_default = 'Your Booking has been approved!';
											$current_subject_value = get_option($subject_var,$subject_default); ?>
...
The Booking you requested at '.get_bloginfo('name').' has been cancelled. For reference, here\'s the Booking information:
...
Your friends at '.get_bloginfo('name');
											...
											$email_content_approval = get_option($option_name,$default_content);
											$section_title = __('Email Content - Booking Cancellation', 'booked'); ?>

											<h3><?php echo esc_attr($section_title); ?></h3>
											<p><?php _e('The email content that is sent to the user upon Booking cancellation. Some tokens you can use:','booked'); ?></p>
											<ul class="cp-list">
												<li><strong>%name%</strong> &mdash; <?php _e("To display the person's name.","booked"); ?></li>
												<li><strong>%email%</strong> &mdash; <?php _e("To display the person's email address.","booked"); ?></li>
												<li><strong>%calendar%</strong> &mdash; <?php _e("To display the calendar name (if one is used) for this Booking.","booked"); ?></li>
											...
											$subject_default = 'Your Booking has been cancelled.';
											$current_subject_value = get_option($subject_var,$subject_default); ?>
...
$default_content = 'You have a new Booking request! Here\'s the Booking information:

Customer: %name%
Date: %date%
Time: %time%

Log into your website here: '.get_admin_url().' to approve this Booking.

(Sent via the '.get_bloginfo('name').' website)';

											$email_content_registration = get_option($option_name,$default_content);
											$section_title = __('New Booking Request', 'booked'); ?>

											<h3><?php echo esc_attr($section_title); ?></h3>
											<p><?php _e('The email content that is sent (to the selected admin users above) upon Booking request. Some tokens you can use:','booked'); ?></p>
											<ul class="cp-list">
												<li><strong>%name%</strong> &mdash; <?php _e("To display the person's name.","booked"); ?></li>
												<li><strong>%email%</strong> &mdash; <?php _e("To display the person's email address.","booked"); ?></li>
												<li><strong>%calendar%</strong> &mdash; <?php _e("To display the calendar name (if one is used) for this Booking.","booked"); ?></li>
											...
											$subject_default = 'You have a new Booking request!';
											$current_subject_value = get_option($subject_var,$subject_default); ?>
...
$default_content = 'One of your customers has cancelled their Booking. Here\'s the Booking information:
...
(Sent via the '.get_bloginfo('name').' website)';
											...
											$email_content_registration = get_option($option_name,$default_content);
											$section_title = __('Booking Cancellation', 'booked'); ?>
											...
											$subject_default = 'A Booking has been cancelled.';
											$current_subject_value = get_option($subject_var,$subject_default); ?>
								...
								<form action="" id="customTimeslots">
									...
									<div id="customTimeslotsWrapper">
										<div id="customTimeslotsContainer">
											...
											<?php // Any custom Bookings saved already?
															...
															foreach ($timeslots as $timeslot => $count):
																...
																echo '<span class="timeslot" data-timeslot="'.$timeslot.'">';
																	...
																	if ($time[0] == '0000' && $time[1] == '2400'):
																		echo '<span class="start"><i class="fa fa-clock-o"></i>&nbsp;&nbsp;' . strtoupper(__('Day Booking','booked')) . '</span>';
																	else :
							...
							<div id="booked-shortcodes" class="tab-content">
								...
								<div class="section-row" style="margin-bottom:-50px;">
									...
									<div class="section-head">
										...
										<h3><?php echo __('Display Bookings List', 'booked'); ?></h3>
										<p><?php _e("You can use this shortcode to display the currently logged in user's upcoming Bookings.","booked"); ?></p>
