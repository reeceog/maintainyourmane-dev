	...
	class booked_appointments_post_type {
		...
		public function create_post_type() {
			...
			register_post_type('booked_appointments',
				array(
					'labels' => array(
						'name'               => __( 'Bookings', 'booked' ),
						'singular_name'      => __( 'Booking', 'booked' ),
						'menu_name'          => __( 'Bookings', 'booked' ),
						'name_admin_bar'     => __( 'Booking', 'booked' ),
						'add_new'            => __( 'Add New', 'booked' ),
						'add_new_item'       => __( 'Add New Booking', 'booked' ),
						'new_item'           => __( 'New Booking', 'booked' ),
						'edit_item'          => __( 'Edit Booking', 'booked' ),
						'view_item'          => __( 'View Booking', 'booked' ),
						'all_items'          => __( 'All Bookings', 'booked' ),
						'search_items'       => __( 'Search Bookings', 'booked' ),
						'parent_item_colon'  => __( 'Parent Bookings:', 'booked' ),
						'not_found'          => __( 'No Bookings found.', 'booked' ),
						'not_found_in_trash' => __( 'No Bookings found in Trash.', 'booked' )
					),
					'show_in_admin_bar' => false,
					'public' => false,
					'has_archive' => false,
					'description' => __('Bookings','booked'),
					'supports' => array(
						'title','author'
					),
