...
;(function($, window, document, undefined) {
	...
	$win.on('load', function() {
	        ...
	        ajaxRequests.push = $.ajaxQueue({
				...
				success	: function(data) {
					if (data == 'success'){
						...
						var	timeslot		= $('#newMatchForm input[name=timeslot]').val(),
							date			= $('#newMatchForm input[name=date]').val(),
							booked_ajaxURL  = $('#data-ajax-url').html(),
		...
		$('body').on('click','.booked-form input#submit-request-appointment',function(e){
			...
			var customerType 		= $('#newMatchForm input[name=customer_type]').val(),
				customerID			= $('#newMatchForm input[name=user_id]').val(),
