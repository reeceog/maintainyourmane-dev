...
function bp_admin_ajax_loaders() {
	...
	*/
	if (isset($_POST['load']) && $_POST['load'] == 'user_info_modal' && isset($_POST['user_id']))
	{
		...
		if (isset($_POST['appt_id'])):
			...
			echo '<br><p><small>'.__('Booking Information','booked').'</small></p>';
	...
	*/
	if (isset($_POST['load']) && $_POST['load'] == 'new_appointment_form' && isset($_POST['date']) && isset($_POST['timeslot']))
	{
		...
		?><p><small><?php _e('New Booking','booked'); ?></small></p>
		...
		<form action="" method="post" class="booked-form" id="newMatchForm"<?php if ($calendar_id): echo ' data-calendar-id="'.$calendar_id.'"'; endif; ?>>
			...
			<div class="field">
				<input type="submit" class="button button-primary" value="<?php _e('Create Booking','booked'); ?>">
